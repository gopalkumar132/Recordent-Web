...
.app-container .content-container .side-menu {
    ...
    transition: width .25s;
        ...
        .col{
            ...
            background-image: url("{{asset('front_new/images/image_bg.jpg')}}");
                            ...
                            <div class="card-body d-flex justify-content-between">
                                <div class="content d-flex align-items-center justify-content-between">
                                    <div class="main" style="text-align: justify;">
                                        <h1 class="weight-light">US Business Credit Report</h1>
                                        ...
                                        <p class="mb-1 medium"><a href="{{route('admin.us.report',['c_id'=>$consent_id])}}">Click here</a> to view the report</p>
                                        <p class="mb-1 medium">A copy of the report is saved under  <a target="_blank" href="{{route('all-records')}}">Report History</a> section of your login under Reports tab. You can view the report at any time. Payment receipt has been emailed to your registered email address.</p>
                                        <p class="mb-1 medium"><a href="{{route('admin.credit-report')}}">Click here</a> to search for Business report for another US partner.</p>
