                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div id="dataTable_filter" class="dataTables_filter">
                            <form action="{{route('my-records-for-sms')}}" method="get">
                            <div class="row">
                            	<div class="col-md-6">
                                ...
                                <div class="col-md-6 text-right text-md-right mt_form">
                                        ...
                                        <a href="{{route('my-records-for-sms')}}" class="btn btn-primary"  aria-controls="dataTable">Reset</a>
                               </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('my-records-send-sms')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            @foreach($smsTemplates as $template_id=>$template_text)
                ...
                <div class="form-group">
                    ...
                    @php
                        $text = General::replaceTextInSmsTemplate($template_id,'INDIVIDUAL',Auth::user());
