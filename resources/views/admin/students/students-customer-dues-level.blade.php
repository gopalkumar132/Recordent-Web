                                        ...
                                        <td class="no-sort no-click bread-actions">
                                           {{-- @can('delete', $data)
                                            ...
                                            @endcan --}}
                                                ...
                                                <a href="" class="btn btn-primary addOutstanding" data-toggle="modal" data-target="#outstanding" data-profile-id="{{$data->profile->id}}" data-custom-id="{{$data->external_student_id}}" title="Add Record">
                                                ...
                                                <a href="" class="btn btn-primary paymentHistoryButton" data-toggle="modal" data-target="#paymentHistory" data-due-id="{{$data->id}}" data-profile-id="{{$data->profile->id}}" data-custom-id="{{$data->external_student_id}}" title="Payment History">
    ...
    <div class="modal commap-team-popup" id="pay" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('student-store-pay', $data->student_id) }}" method="POST" onSubmit="document.getElementById('update_payment_disabled').disabled=true;">
                @csrf
                ...
                @if(General::checkMemberEligibleToSkipCollectionPayment() && Auth::user()->collection_fee_individual == 0)
                <div class="form-check">
               ...
               <input type="hidden" name="EdithiddenDuedate" class="EdithiddenDuedate" value="">
                ...
                <div class="form-group proof_of_due_main_div">
                   ...
                   <!-- <div class="proof_of_due_div">
                    ...
                    <!-- <label for="due_note">Proof of Due</label>
                    <input type="file" id="editFileupload" class="form-control fl-upload-height" name="proof_of_due" multiple accept='.jpg,.png,.jpeg,.pdf,.doc,.docx,.xls,.xlsx,.bmp,.csv'>
        ...
        $('.editDueButton').on('click', function () {
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    //$("#edit").find(".modal-body").find('input[name=external_student_id]').prop('readonly', false);
                    ...
                    // $("#edit").find(".modal-body").find('input[name=balance_amount]').prop('readonly', true);
                    $("#edit").find(".modal-body").find('input[name=due_date]').prop('readonly', false);
                    //$("#edit").find(".modal-body").find('input[name=external_student_id]').prop('readonly', true);
                    ...
                    //$("#edit").find(".modal-body").find('input[name=external_student_id]').val(data.external_student_id).trigger("input");
                    ...
                    if($.trim(data.proof_of_due).length>0){
                        ...
                        var res = str.replace("proof_of_due/", "");
                        ...
                        for(var i=0;i<imglist.length;i++)
                        {
                           ...
                           '<a id="delete_proof_of_due" href="javascript:void"  onclick="remove_proofof_due_file('+dueId+','+file_name_img+','+i+')" data-due-id="'+dueId+'">Delete Proof Of Due</a>'
                           +'</span><br>';
                            }
                        }
