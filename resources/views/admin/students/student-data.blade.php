	                        ...
	                        <table id="dataTable" class="table table-hover fixed_headerss">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <td class="balance">{{General::ind_money_format($data->due_amount - General::getPaidForDue($data->dueId, Auth::id()))}}</td>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form action="{{ route('student-store-due', $studentId) }}" method="POST" enctype="multipart/form-data">
				@csrf										
    ...
    <div class="modal" id="pay" tabindex="-1" role="dialog">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form action="{{ route('student-store-pay', $studentId) }}" method="POST">
				@csrf	
    ...
    <div class="modal" id="edit" tabindex="-1" role="dialog">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form action="{{ route('student-edit-due', $studentId) }}" method="POST" enctype="multipart/form-data">
				@csrf
				@method('put')			
				<input type="hidden" name="outstanding" value="">										
				<div class="form-group">
