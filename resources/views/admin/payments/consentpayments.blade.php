...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list"></i> Reports Payments
    </h1>
    @if (count($errors) > 0)
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div id="dataTable_filter" class="dataTables_filter">
                            <form action="{{route('admin.consentpayments-listing')}}" method="get">
                                <div class="row">
                                	<div class="col-md-12">
                                        <div class="col-md-2">
                                            ...
                                            <select name="payment_type" class="form-control input-sm">
                                                ...
                                                <option value="INDIVIDUAL" {{ app('request')->input('payment_type')=='INDIVIDUAL' ? 'selected' : '' }}>Individual Report</option>
                                                <option value="BUSINESS" {{ app('request')->input('payment_type')=='BUSINESS' ? 'selected' : '' }}>Business Report</option>
                                                <option value="USBUSINESS" {{ app('request')->input('payment_type')=='USBUSINESS' ? 'selected' : '' }}>US Business Report</option>
                                        ...
                                        <div class="col-md-6 text-right text-md-right mt_form">
                                            ...
                                            <a href="{{route('admin.consentpayments-listing')}}" class="btn btn-primary"  aria-controls="dataTable">Reset</a>
                                        </div>
                                    </div>
                                </div>
                           </form>
            ...
            <div class="col-md-3 float-right float-sm-right">
                ...
                <label style="font-family: var(--font-rubik);font-weight: 400;">Choose Payments Option types</label>
                    <select class="form-control"  name="payment_option_type" required id="slectPaymentOptionType">
                        ...
                        <option value="consentpayments" selected>Reports Payments</option>
                    </select>
                    </div>
                </div>
            <div class="col-md-12">
