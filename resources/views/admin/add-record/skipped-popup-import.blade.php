    ...
    <div class="row">
        @php
            if($member_id = \Session::get('member_id')){
                ...
                $user = Auth::user();
                $popup_on_close_redirect_url = route('import-excel-view');
            }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    @include('admin.add-record.partials.skipped-popup-modal-footer', [
                        'user' => $user,
                        'dues_type_prepaid_or_postpaid' => $user->reports_individual_additional_customer,
                        'dues_payment_url_prepaid' => route('admin.due.payment',['id' => $SkippedDuesRecord->id, 'type' => 'import']), 'plan_upgrade_url' => route('upgrade-plan-due',['id' => $SkippedDuesRecord->id, 'type' => 'import']), 'dues_import_postpaid_url' => route('admin.due.postpaid',['id' => $SkippedDuesRecord->id, 'type' => 'import']),
                    ])
                </div>
            </div>
        </div>
