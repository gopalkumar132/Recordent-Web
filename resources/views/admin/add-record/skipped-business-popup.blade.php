            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    @include('admin.add-record.partials.skipped-popup-modal-footer', [
                        'user' => Auth::user(),
                        'dues_type_prepaid_or_postpaid' => Auth::user()->reports_business_additional_customer,  
                        'dues_payment_url_prepaid' => route('admin.business.due.payment',['id' => $SkippedDuesRecord->id]), 'plan_upgrade_url' => route('upgrade-plan-business',['id' => $SkippedDuesRecord->id]), 'dues_import_postpaid_url' => route('admin.business.due.postpaid',['id' => $SkippedDuesRecord->id]),
                    ])
                </div>
            </div>
        </div>
...
<script>
    ...
    $(window).on('load', function() {
        ...
        $('#myModal').on('hidden.bs.modal', function () {
            window.location.href = "{{ route('business.add-record') }}";
        });
    });
</script>
@endsection