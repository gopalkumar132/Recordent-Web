...
<div class="report-gen">
    ...
    <table  width="100%" class="table table-hover full-boder">
        ...
        <tr>
            <td colspan="8" align="center" class="main-title">Recordent Individual Report</td>
        </tr>
        <tr class="">
         ...
         <tr class="bg-color">
            <td colspan="8" class="center-align w-100 sub-title" align="center">Personal Details</td>
        </tr>
        <tr>
            <td class="f-w-6">Consumer Name</td>
            <td >{{$data->person_name}}</td>
            <td colspan="4" width="48%" style="width:48% !important"></td>
            <td class="f-w-6">Aadhar Number (last 6 digits)</td>
             <td >
        ...
        <tr>
            ...
            <td colspan="4" width="48%" 48style="width:72% !important"></td>
             <td class="f-w-6">Mobile Number</td>
            <td>
                {{$data->contact_phone}}
            </td>    
        </tr>
                ...
                <td colspan="8" class="p-0 b-0">
                    <table width="100%">
                        ...
                        <tr class="">
                            ...
                            <td colspan="5" class="f-w-6" style="word-break: break-all;">
                                {{$disputeComment}}
                            </td>
                        </tr>
