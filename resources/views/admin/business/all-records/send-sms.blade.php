                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div id="dataTable_filter" class="dataTables_filter">
                            <form action="{{route('admin.business.all-records-for-sms')}}" method="get">
                            <div class="row">
                            	<div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="organization_id"class="form-control input-sm select2" placeholder="" aria-controls="dataTable">
                                            ...
                                            @foreach($organizations as $organization) 
                                                <option value="{{$organization->id}}" {{app('request')->input('organization_id')== $organization->id ? 'selected' : '' }}>{{$organization->business_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="col-md-6 text-right text-md-right mt_form">
                                        ...
                                        <a href="{{route('admin.business.all-records-for-sms')}}" class="btn btn-primary btn-red"  aria-controls="dataTable">Reset</a>
                               </div>
                            ...
                            <table id="dataTable" class="table table-hover fixed_headerss">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center !important;">{{$data->addedBy->business_name}}@if(!empty($data->addedBy->userType)) ({{$data->addedBy->userType->name }}) @endif</td>
                                        <!-- <td  style="text-transform:uppercase">{{$data->profile->company_name}}<br>
                                        ...
                                        <td  style="text-transform:uppercase;text-align: center !important;">{{$data->profile->company_name}}<br>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('admin.business.all-records-send-sms')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            @foreach($smsTemplates as $template_id=>$template_text)
                ...
                <div class="form-group">
                    ...
                    @if(empty(request()->organization_id))
                       @php $text = General::replaceTextInSmsTemplate($template_id,'BUSINESS'); @endphp
                    @else    
                       @php $text = General::replaceTextInSmsTemplate($template_id,'BUSINESS',$authUser); @endphp
                    @endif
