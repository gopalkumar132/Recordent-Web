...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list"></i> My Records
    </h1>
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div id="dataTable_filter" class="dataTables_filter">
                            ...
                            <form action="{{route('business-records-for-member')}}" method="get">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control input-sm" name="from_date" id="from_date">
                            </div>
                        </div>
                        <div class="col-md-2">
                        <div class="form-group">
                        <label style="font-family: var(--font-rubik);font-weight: 400;">To Date:</label>
                            <input  class="form-control input-sm" type="date" name="to_date" id="to_date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="">
                            <form action="{{route('export-business')}}" id="dueBtn">
                                ...
                                <button class="form-control btn btn-info  btn-blue" style="width:165px !important">Due Records <i class="voyager-download"></i>
                                </button>
                            </form>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="">
                            <form action="{{route('export-business-payments')}}" id="paymentBtn">
                                ...
                                <label style="font-family: var(--font-rubik);font-weight: 400;width:160px !important"></label>
                                <button style="width:180px !important" class=" form-control btn btn-info  btn-blue">Invoice Payments<i class="voyager-download"></i>
                                </button>
                            </form>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <form action="{{route('export-business-payments')}}" id="paymentBtn">
                                ...
                                <input type="hidden" id="PaymendropDownType" name="paymentdropDownType" value="">
                                <label style="font-family: var(--font-rubik);font-weight: 400;width:160px !important"></label>
                                <button style="width:190px !important" class=" form-control btn btn-info  btn-blue">Customer Payments<i class="voyager-download"></i>
                                </button>
                            </form>
                            </div>
                        </div>
                            ...
                            <table id="dataTable" class="table table-hover fixed_headerss">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{{General::ind_money_format(General::getTotalDueForBusinessByCustomId($data->id,$userId,$data->dueid,$data->external_business_id) - General::getTotalPaidForBusinessByCustomId($data->id,$userId,$data->dueid,$data->external_business_id)) }}</td>
                                        <td>{{$data->external_business_id}}</td>
                                        <td class="no-sort no-click bread-actions">
                                                <a href="{{ route('business.my-business-records',[$data->id,$data->dueid]) }}" class="btn btn-sm btn-warning view" title="view Record">
                                                    <i class="voyager-eye"></i>
                                                </a>
                                                <a href="" class="btn btn-success addPayButton" data-toggle="modal" data-target="#updatemodal" data-due-id="{{ $data->{$data->getKeyName()} }}" data-due-profileid ="{{$data->dueid}}" data-due-customId ="{{$data->external_business_id}}" data-backdrop="static">
                                                <i class="fa fa-money" aria-hidden="true"></i>
                                                </a>
                                                 <a href="" class="btn btn-primary paymentHistoryButton" data-toggle="modal" data-target="#paymentHistory" data-due-id="{{ $data->{$data->getKeyName()} }}" data-due-profileid ="{{$data->dueid}}" data-due-customId ="{{$data->external_business_id}}" title="Payment History">
                                                <i class="fa fa-history" aria-hidden="true"></i>
                                            </a>
                                                <a href="" class="btn btn-success prrofOfDue" data-toggle="modal" 
                                                data-target="#pay" data-studentid="{{$data->id}}" data-id="{{$data->dueid}}" data-custid="{{$data->external_business_id}}" data-profilename="{{$data->company_name}}"  title="Upload Proof of due" >
     ...
     <div class="modal commap-team-popup fade" tabindex="-1" id="updatemodal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                 <form id="updatepaymentform" method="POST" action="{{route('business-store-pay-customer-level')}}">
                     @csrf
                    <div id="voyager-loader-popup1"  style="display:none">
                          <img src="{{ voyager_asset('images/logo-icon.png') }}" alt="Voyager Loader"> 
                    </div>
                    <input type="hidden" name="business_id" value="" id="business_id">
                    <input type="hidden" name="business_due_id" value="" id="business_due_id">
   ...
   <div class="modal commap-team-popup slider_Popup" id="pay" tabindex="-1" role="dialog" >
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="height:500px;">
          ...
          <div class="modal-body">
            <form action="{{route('business-upload-proof-due-customlevel')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group proofofdue_check_errclass files color noProof_ofDue">
                    ...
                    position: absolute;top: 149px;left: 0;width: 50px;right: 0;height: 56px;content: none;display: block;margin: 0 auto;background-size: 100%;background-repeat: no-repeat;">
    ...
    <div class="modal-dialog">
      <div class="modal-content" >
        ...
        <div class="modal-body" style="height:400px;">
            ...
            <form action="{{route('business-assign-proof-duelevel')}}" method="POST" enctype="multipart/form-data">
            @csrf
...
$(".prrofOfDue").on("click",function(){
    ...
    $("#dataTablepopup").html("");
        $.ajax({
                       method: 'post',
                       url: "{{route('business-listof-dues')}}",
                       headers: {
                ...
                var business_nsme="";
                    ...
                    { 
                       ...
                       var business_id=data[i].business_id;
                        business_nsme=data[0].company_name;
                       $("#busin_customer_name").val(business_nsme);
                        ...
                        if(str_val){
                               var res = str_val.replace("business/proof_of_due/", "");
                                ...
                                for(var j=0;j<imglist.length;j++)
                                {
                                    ...
                                    imglink+= "<div class='slideitem  "+cls+"'><"+tag+" src="+proofofdue+imglist[j]+" "+cssStyle+"'><br><div class='col-lg-6 custmUpload'>"+
                    ...
                    $(".asign_prrof_due").on("click",function(){
                        ...
                        // var proofof_due_file=$("#proof_val").val();
                        ...
                        $.ajax({
                       method: 'post',
                       url: "{{route('business-assigned-file-check-isexist')}}",
                       headers: {
                           'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                       },
                       data: {
...
<script type="text/javascript">
 ...
 $('.addPayButton').on('click', function () {
      ...
      // console.log(customId);
         ...
         $.ajax({
                    method: 'GET',
                    url: "{{route('get-total-Due-For-Business-By-CustomId')}}",
                    data: {
    ...
    $("#updatemodal").find(".modal-body").find('input[name=business_id]').val(profileId);
    $("#updatemodal").find(".modal-body").find('input[name=business_due_id]').val(DueId);
        ...
        if(Number(payment_amount) < Number(due_amount) && payment_options==''){
          ...
          // $('#skip_payment_invoices').show();
           ...
           $('#payment_screen').hide();
            $.ajax({
                    method: 'GET',
                    url: "{{route('get-business-dues-customer-level')}}",
                    data: {
                        businessID: profileId,
                        dueId: DueId,
                        custom_id: customId
    ...
    function submitpaymentsinvoices(){
        ...
        if (typeof checked_values !== "undefined" && checked_values.value == '') {
             document.getElementById("alert_text_red").style.display = "block";
              document.getElementById("alert_text_red").innerHTML = "Select atleast one checkbox";
        } else if(parseInt(latest_amount)>0) {
          document.getElementById("alert_text_red").style.display = "block";
              document.getElementById("alert_text_red").innerHTML = "Adjust whole amount";
        } 
        else {
           document.getElementById("updatepaymentform").submit(); 
        }
