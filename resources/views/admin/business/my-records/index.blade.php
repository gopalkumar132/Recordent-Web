                                     ...
                                     <td>{{$data->profile->company_name}}</td>                 
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                               {{-- <a href="{{ route('business.business-data', $data->profile->id) }}" class="btn btn-sm btn-warning view" title="view Record">
                                                ...
                                                <a href="" class="btn btn-primary paymentHistoryButton" data-toggle="modal" data-target="#paymentHistory" data-due-id="{{$data->id}}" title="Payment History">
    ...
    <div class="modal commap-team-popup" id="pay" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('business.business-store-pay', $data->business_id) }}" method="POST">
                @csrf   
          ...
          <div class="modal-body">
            ...
            <form action="{{ route('business.business-edit-due', $data->business_id) }}" method="POST" enctype="multipart/form-data" id="new_data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" minlength="3" name="concerned_person_name" value="" placeholder="Concerned Person Name*" maxlength="{{General::maxlength('name')}}" required onblur="trimIt(this);">
                </div> 
                <div class="form-group">
            ...
            $.ajax({
                ...
                success:function(res){
                   ...
                   // console.log(res);
                    ...
                    $("#edit").find(".modal-body").find('input[name=concerned_person_name]').prop('readonly', false);
                    ...
                    $("#edit").find(".modal-body").find('input[name=due_amount]').prop('readonly', false);
                    $("#edit").find(".modal-body").find('input[name=concerned_person_name]').prop('readonly', true);
                    ...
                    $("#edit").find(".modal-body").find('input[name=concerned_person_name]').val(personal_data.concerned_person_name);
                    ...
                    if(parseInt(result) > parseInt(days))
                    {
                        ...
                        if(parseFloat(balanceVal) <= parseFloat(due_amount))
                        {
                            ...
                            $("#edit").find(".modal-body").find('input[name=balance_due]').val(totalBal);
                        }else{
