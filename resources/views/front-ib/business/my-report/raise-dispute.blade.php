...
<div class="page-content container-fluid">
                        ...
                        <div class="table-responsive">
                            <table class="table full-boder">
                                ...
                                @if($duesRecord)
                                    ...
                                    <tr class="account-de d-flex">
                                        @php
                                            $amountDue = $duesRecord->due_amount - General::getPaidForDueOfBusiness($duesRecord->id);
                                        @endphp
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-bordered">
                <div class="panel-body">
                    <form action="{{route('front-business.store-raise-dispute',$duesRecord->id)}}" name="add_store_record" id="add_store_record" method="POST" enctype="multipart/form-data">
                        @csrf   
