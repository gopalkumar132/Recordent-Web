...
<!-- End Google Tag Manager -->
    ...
    @else
    <title>Verify Mobile Number-{{ Voyager::setting("site.title") }}</title>
    @endif
                            ...
                            <div class="login-container">
        						<ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                      ...
                                      @else
                                      <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#individualLogin" role="tab" aria-controls="individualLogin" aria-selected="true">Verify Mobile Number</a>
                                      @endif
                                    </li>
        						</ul>
                                    ...
                                    <div class="tab-pane fade show active" id="individualLogin" role="tabpanel" aria-labelledby="individualLogin-tab">
                                        ...
                                        <form action="{{ route('individual.login') }}" method="POST" id="individualLoginForm" class="hide">
                                            <div class="row">
                                                ...
                                                <input type="hidden" name="utmsource" id="utmsourceLogin" value="{{$utmsource}}"/>
                                                <div class="col-md-12 mb-0">
                                                    <div class="btn-submiteeee">
        ...
        <script>
            ...
            var utmsource = form.find('input[name=utmsource]').val();
              ...
              if(utmsource=="") {
                ...
                window.location.href="https://inpromo1.recordent.com/knowaboutrecordent";
              }
