    ...
    */
    ...
    'dashboard' => [
        ...
        'navbar_items' => [
            ...
            'Update email' => [
                'route'      => 'admin.profile.edit-email',
                'classes'    => '',
                'icon_class' => 'voyager-settings',
            ],
            'Update mobile number' => [
                'route'      => 'admin.profile.edit-mobile',
                'classes'    => '',
                'icon_class' => 'voyager-settings',
            ],
            'Change password' => [
        ...
        'widgets' => [
			...
			'App\\Widgets\\LaDPersDimmer',
			'App\\Widgets\\DueDimmer',
			'App\\Widgets\\LaDPersDimmerBusiness',
			'App\\Widgets\\DueDimmerBusiness',
        ],
