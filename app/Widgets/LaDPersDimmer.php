...
class LaDPersDimmer extends AbstractWidget
{
    /**
    ...
    public function run()
    {
		...
		//$records = $records->groupBy('student_id')->get();
		$records = $records->get();
        $count = $records->count();
        $string = "<div class='total-amount-due'><span class='someeeee'>Number of Due Records (Individual Customers) </span></div>";//trans_choice('voyager::dimmer.page', $count);
        ...
        return view('voyager::dimmer', array_merge($this->config, [
            ...
            'image' => 'ladpers.jpg',
			'helper' => '*LaDPers = Late & Default Payments',
        ]));
    }
