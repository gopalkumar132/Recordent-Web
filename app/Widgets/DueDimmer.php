...
class DueDimmer extends AbstractWidget
{
    /**
    ...
    public function run()
    {
	     ...
	     $totalDueFee = \App\StudentDueFees::select(DB::raw('sum(due_amount) as Due'));
		$totalPaidFee = \App\StudentPaidFees::select(DB::raw('sum(paid_amount) as Paid'));
        ...
        $string = "<div class='total-amount-due'><span class='someeeee'>Total Value of Individual Customer Dues</span></div>";//trans_choice('voyager::dimmer.page', $count);
